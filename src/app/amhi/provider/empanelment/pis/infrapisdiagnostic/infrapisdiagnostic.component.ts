...
@Component({
    selector: 'infra-pis-diagnostic',
    encapsulation: ViewEncapsulation.None,
    template: require('./infrapisdiagnostic.html'),
    styles: [require('./infrapisdiagnostic.scss')]
})
export class Infrapisdiagnostic {
    ...
    public ambulanceOwneroptions: string[] = ["Owned", "Out Sourced"];
