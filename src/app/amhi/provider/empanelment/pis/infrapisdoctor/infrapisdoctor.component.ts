...
@Component({
    selector: 'infra-pis-doctor',
    encapsulation: ViewEncapsulation.None,
    template: require('./infrapisdoctor.html'),
    styles: [require('./infrapisdoctor.scss')]
})
export class Infrapisdoctor {
    ...
    private doorStep: any = "Yes";
    private doorStepName: any = "doorStepName";
    private doorStepOptions: any [] = [{name:"Yes",id:"Yes"}, {name:"No", id:"No"}];
    private MedRecord: any = "Yes";
    private MedRecordName: any = "MedRecordName";
    private MedRecordOptions: any [] = [{name:"Yes",id:"Yes"}, {name:"No", id:"No"}];
    private storageType: any = "Yes";
    private storageTypeName: any = "storageTypeName";
    private storageTypeOptions: any [] = [{name:"Yes",id:"Yes"}, {name:"No", id:"No"}];
    private billPattern: any = "Yes";
    private billPatternName: any = "billPatternName";
    private billPatternOptions: any [] = [{name:"Yes",id:"Yes"}, {name:"No", id:"No"}];

    public ambulanceFacility: any = "Available";
    public ambulanceFacilityName: any = "ambulanceFacility";
    public ambulanceFacilityoptions: string[] = ["Available", "Not Available"];
    
    public backupFacility: any = "Available";
    public backupFacilityName: any = "backupFacility";
    public backupFacilityoptions: string[] = ["Available", "Not Available"];
    
    public backupType: any = "Generator";
    public backupTypeName: any = "backupType";
    public backupTypeoptions: string[] = ["Generator", "UPS"];
