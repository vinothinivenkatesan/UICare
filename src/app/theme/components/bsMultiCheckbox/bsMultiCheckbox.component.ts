...
@Component({
  selector: 'bs-multi-checkbox[ngModel]',
  template: require('./bsMultiCheckbox.html'),
})
export class BsMultiCheckbox implements ControlValueAccessor {
  @Input() bsMultiCheckboxClass:string;
